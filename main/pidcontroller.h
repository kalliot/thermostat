...
extern void pidcontroller_init(uint8_t *chip, int interval, int max, float diff, float tDiverge, float sDiverge);
extern void pidcontroller_reinit(int interval, int max, float diff, float tDiverge, float sDiverge);
